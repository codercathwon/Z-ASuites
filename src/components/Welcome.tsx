      ...
      <div className="relative min-h-[85vh] flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 w-full px-6 flex flex-col pt-32 pb-24 md:pb-32">
          <div className="max-w-6xl mx-auto w-full">
            ...
            >
              <h2 className="font-serif font-semibold text-[14vw] sm:text-[5.5rem] md:text-[6rem] lg:text-[7rem] leading-[0.8] text-za-white tracking-tighter drop-shadow-xl break-words">
                ABOUT
              </h2>
              <h2 className="font-serif font-semibold text-[14vw] sm:text-[5.5rem] md:text-[6rem] lg:text-[7rem] leading-[0.8] text-za-white tracking-tighter drop-shadow-2xl break-words">
                US
              </h2>
