    ...
    <section id="gallery" className="py-24 md:py-32 bg-[#1A1614] relative">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col items-center justify-center text-center mb-20 w-full">
          ...
          >
            <h2 className="font-serif font-semibold text-[13vw] sm:text-[5rem] md:text-[5.5rem] lg:text-[6.5rem] leading-[0.8] text-za-cream tracking-tighter drop-shadow-xl uppercase w-full break-words">
              THE SUITE
            </h2>
            <h2 className="font-serif font-semibold text-[13vw] sm:text-[5rem] md:text-[5.5rem] lg:text-[6.5rem] leading-[0.8] text-za-cream tracking-tighter drop-shadow-2xl uppercase w-full break-words">
              IN DETAIL
            </h2>
